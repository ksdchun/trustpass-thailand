...
import { ArrowRight, BadgeCheck, BarChart3, Bot, FileText, ShieldAlert, ShieldCheck, Sparkles } from "lucide-react";
import { SiteNav } from "@/components/SiteNav";
import { azureServices, evidenceCards, scenarios } from "@/lib/demo-content";
...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="border-b border-fluent-border bg-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-14">
          ...
          <div className="rounded-[8px] border border-fluent-border bg-fluent-canvas p-3 shadow-soft">
            <Image src="/trustpass-product-flow.png" alt="TrustPass Thailand product flow" width={1400} height={788} className="h-auto w-full rounded-[8px] border border-fluent-border bg-white" priority />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold text-ink">One chat interface, four scam scales.</h2>
          </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-5 grid gap-3">
              {[
                ...
                ["Transformational", "Aggregates risk signals into a dashboard for hotels, TAT, and tourist police."]
              ].map(([title, text]) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-6">
            <p className="text-sm font-bold uppercase tracking-wide text-azure">Azure AI Stack</p>
          <h2 className="mt-2 text-3xl font-bold text-ink">Azure AI powers the trust workflow.</h2>
        </div>
